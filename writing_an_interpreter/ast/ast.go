...
// Functions that the program type requires
...
// INFO: This lets you hold on expression
...
// INFO: infix expressions
type InfixExpression struct {
	Token    token.Token // the infix token, eg, +
	Left     Expression
	Operator string
	Right    Expression
}
